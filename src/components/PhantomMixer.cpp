...
void PhantomMixerComponent::init()
{
    ...
    m_mixerOscBalanceSlider->setTextBoxStyle(Slider::NoTextBox, false, m_textBoxWidth, m_textBoxHeight);
    ...
    m_mixerAmpGainSlider->setTextBoxStyle(Slider::NoTextBox, false, m_textBoxWidth, m_textBoxHeight);
    ...
    m_mixerRingModSlider->setTextBoxStyle(Slider::NoTextBox, false, m_textBoxWidth, m_textBoxHeight);
    ...
    m_mixerNoiseSlider->setTextBoxStyle(Slider::NoTextBox, false, m_textBoxWidth, m_textBoxHeight);
